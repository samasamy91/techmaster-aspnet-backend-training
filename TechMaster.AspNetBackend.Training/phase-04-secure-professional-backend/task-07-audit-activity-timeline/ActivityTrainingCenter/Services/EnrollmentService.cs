...
namespace TrainingCenter.Api.Services
{
    public class EnrollmentService : IEnrollmentService
    {
        ...
        public EnrollmentService(AppDbContext context, ILogger<EnrollmentService> logger, IActivityLogService logService)
        {
        ...
        public async Task<EnrollmentDetailsResponse> CreateEnrollment(CreateEnrollmentRequest request, ClaimsPrincipal user)
        {
            ...
            await logService.Log(user, "Enrollment Requested", "Enrollment", enrollment.EnrollmentId, $"Enrollment requested for student {enrollment.StudentId}");
        ...
        public async Task<bool> UpdateStatusEnrollment(int id,UpdateEnrollmentStatusRequest request, ClaimsPrincipal user)
        {
            ...
            await logService.Log(user, "Enrollment Status Updated", "Enrollment", enrollment.EnrollmentId, $"Enrollment status changed from {oldStatus} to {newStatus}",
                metadata: System.Text.Json.JsonSerializer.Serialize(new
                {
                    OldStatus = oldStatus,
                    NewStatus = enrollment.Status.ToString()
                }));
