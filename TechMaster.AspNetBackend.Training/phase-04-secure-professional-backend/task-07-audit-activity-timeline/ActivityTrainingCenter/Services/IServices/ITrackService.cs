...
namespace TrainingCenter.Api.Services.IServices
{
    ...
    {
        Task<PagedResult<TrackDetailsResponse>> GetAllTracks(string? keyword,
        ...
        Task<TrackDetailsResponse> CreateTrack(CreateTrackRequest request, ClaimsPrincipal user);
        ...
        Task<bool> AssignInstructor(int trackId, int instructorId);
    }
}
