...
namespace TrainingCenter.Api.Services.IServices
{
    public interface IPaymentService
    {
        ...
        Task<PaymentResponse> CreatePayment(CreatePaymentRequest request, ClaimsPrincipal user);
        Task<IEnumerable<PaymentResponse>> GetEnrollmentPayments(int enrollmentId);
        Task<bool> UpdateStatusPayment(int paymentId, UpdatePaymentStatusRequest request, ClaimsPrincipal user);
    }
}
