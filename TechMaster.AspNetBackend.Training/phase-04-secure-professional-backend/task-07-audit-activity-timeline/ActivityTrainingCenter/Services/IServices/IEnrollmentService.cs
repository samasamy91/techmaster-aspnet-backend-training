...
namespace TrainingCenter.Api.Services.IServices
{
    public interface IEnrollmentService
    {
        ...
        Task<EnrollmentDetailsResponse> CreateEnrollment(CreateEnrollmentRequest request, ClaimsPrincipal user);
        Task<bool> UpdateStatusEnrollment(int id, UpdateEnrollmentStatusRequest request, ClaimsPrincipal user);
