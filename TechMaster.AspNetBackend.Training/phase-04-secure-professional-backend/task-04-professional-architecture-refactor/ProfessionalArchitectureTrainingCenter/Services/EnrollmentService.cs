...
namespace TrainingCenter.Api.Services
{
    public class EnrollmentService : IEnrollmentService
    {
        ...
        public async Task<object> RequestEnrollment(StudentEnrollmentRequest request,ClaimsPrincipal user)
        {
            ...
            if (student == null)
                throw new UnauthorizedAccessException("Student account not found");
            ...
            if (track.Status != TrackStatus.Active)
                throw new BadHttpRequestException("Track not acception enrollments");
            ...
            if (existingEnroll)
                throw new BadHttpRequestException("You already enrolled in this track");
            ...
            if (activeCount >= track.Capacity)
                throw new BadHttpRequestException("This track is full");
