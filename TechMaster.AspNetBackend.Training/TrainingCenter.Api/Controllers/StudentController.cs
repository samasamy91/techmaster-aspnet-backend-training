...
namespace TrainingCenter.Api.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllStudent([FromQuery] string? search,
            [FromQuery]bool? isActive, [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10)
        {
            var students = await studentService.GetAllStudent(search, isActive, pageNumber, pageSize);
